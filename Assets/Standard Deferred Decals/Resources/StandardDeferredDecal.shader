...
Shader "SDD Standard Deferred Decal"
{
    Properties
    {
		...
		//$$$------
		_Cutoff("Alpha Cutoff", Range(0.0, 1.0)) = 0.00001
		_Overal_Alpha("Overal Alpha", Range(0.0, 1.0)) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "StandardDeferedDecalInclude.cginc"
			//$$$------
    ...
    FallBack "VertexLit"
    CustomEditor "StandardDeferredDecalGUI"
}
