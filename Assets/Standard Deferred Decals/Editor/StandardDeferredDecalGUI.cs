...
{
    internal class StandardDeferredDecalGUI : ShaderGUI
    {
		...
		{
			//$$$--------------------------------------
			public static GUIContent overalAlphaText = new GUIContent("Overal Alpha", "Overall alpha multiplier");
			public static GUIContent diffuseAlphaText = new GUIContent("Diffuse Alpha", "Diffuse alpha multiplier");
			public static GUIContent normalAlphaText = new GUIContent("Normal Alpha", "Normal alpha multiplier");
			public static GUIContent specularAlphaText = new GUIContent("Specular Alpha", "Specular alpha multiplier");
			public static GUIContent smoothnessAlphaText = new GUIContent("Smoothness Alpha", "Smoothness alpha multiplier");
			public static GUIContent occlusionAlphaText = new GUIContent("Occlusion Alpha", "Occlusion alpha multiplier");
			//$$$--------------------------------------
            ...
            public static bool zWrite = false;
            public static int renderQueue = 1;
			//$$$--------------------------------------
		...
		//$$$--------------------------------------
		MaterialProperty overalAlpha = null;
        MaterialProperty diffuseAlpha = null;
        MaterialProperty normalAlpha = null;
        MaterialProperty specularAlpha = null;
        MaterialProperty smoothnessAlpha = null;
        MaterialProperty occlusionAlpha = null;
		//$$$--------------------------------------
        ...
        {
			//$$$--------------------------------------
			overalAlpha = FindProperty("_Overal_Alpha", props);
			diffuseAlpha = FindProperty("_Diffuse_Alpha", props);
			normalAlpha = FindProperty("_Normal_Alpha", props);
			specularAlpha = FindProperty("_Specular_Alpha", props);
			smoothnessAlpha = FindProperty("_Smoothness_Alpha", props);
			occlusionAlpha = FindProperty("_Occlusion_Alpha", props);
			//$$$--------------------------------------
